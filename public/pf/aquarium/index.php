    ...
    <div class="top-bar flex">
        ...
        <ul class="login flex flex-ai-c">
            <li class="flex flex-ai-c"><a href="#" class="flex flex-ai-c">
                    ...
                    <img class="v" src="https://hwanghyeonjeong.github.io/img1/pf/aquarium/Untitled-2.png" alt="">
                </a></li>
            <li class="flex flex-ai-c"><a href="#" class="flex">
                    <img class="ticket flex-ai-c" src="https://hwanghyeonjeong.github.io/img1/pf/aquarium/ticket.png"
                        alt="">
            ...
            <div class="con">
                ...
                <div class="cover">
                    <div class="pro pro1 flex">
                        ...
                        <div class="box box-4">
                            <div class="text">매주 월요일은<br>악어쇼, 다이버의 수중탐사, 닥터피쉬<br>체험은 운영하지 않습니다.<br>
                                이용에 참고하여 주시기 바랍니다</div>
                        </div>
                    </div>
                    <div class="pro pro2 flex">
                        ...
                        <div class="box box-8">
                            ...
                            <img class="blue" src="https://hwanghyeonjeong.github.io/img1/pf/aquarium/bird1.png" alt="">
