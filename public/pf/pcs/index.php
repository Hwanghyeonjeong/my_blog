...
<body>
        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="background">
                    <div
                        style="background-image:url(https://hwanghyeonjeong.github.io/img1/pf/pcs/200526_main_PC_01-1500x797.png);">
                    </div>
                    <div
                        style="background-image:url(https://globalesports.wpengine.com/wp-content/uploads/2020/06/200608_main_Mobile_NA-2.png);">
                    </div>
                </div>
                <div class="txt-box">
                    <h2 class="title">PUBG CONTINENTAL SERIES 1</h2>
                    <p class="area">PUBG Esports Player Stats+(PEPS+)</p>
                    <a class="more" href="https://pubgesports.eu/en">VIEW MORE</a>
                </div>
            </div>
            <div class="item">
                <div class="background">
                    <div
                        style="background-image:url(https://hwanghyeonjeong.github.io/img1/pf/pcs/200608_main_PC_APAC-2-1500x797.png);">
                    </div>
                    <div
                        style="background-image:url(https://globalesports.wpengine.com/wp-content/uploads/2020/06/200608_main_Mobile_NA-2.png);">
                    </div>
            ...
            <div class="item">
                <div class="background">
                    <div
                        style="background-image:url(https://hwanghyeonjeong.github.io/img1/pf/pcs/200608_main_PC_ASIA-2-1500x797.png);">
                    </div>
                    <div
                        style="background-image:url(https://globalesports.wpengine.com/wp-content/uploads/2020/06/200608_main_Mobile_NA-2.png);">
                    </div>
            ...
            <div class="item">
                <div class="background">
                    <div
                        style="background-image:url(https://hwanghyeonjeong.github.io/img1/pf/pcs/200608_main_PC_EU-2-1500x797.png);">
                    </div>
                    <div
                        style="background-image:url(https://globalesports.wpengine.com/wp-content/uploads/2020/06/200608_main_Mobile_NA-2.png);">
                    </div>
            ...
            <div class="item">
                <div class="background">
                    <div
                        style="background-image:url(https://hwanghyeonjeong.github.io/img1/pf/pcs/200608_main_PC_NA-2-1500x797.png);">
                    </div>
                    <div
                        style="background-image:url(https://globalesports.wpengine.com/wp-content/uploads/2020/06/200608_main_Mobile_NA-2.png);">
                    </div>
    ...
    <div class="top-bar flex con flex-height-100p">
        <div class="logo flex-ai-c"><a href="#"><img
                    src="https://hwanghyeonjeong.github.io/img1/pf/pcs/global-pcs-logo.png" alt=""></a></div>
        <div class="menu-box-1  flex-grow-1 flex-jc-c flex-1-0-0 flex-ai-c ">
            <ul class="flex height-100p flex-grow-1  flex-ai-c">
                <li><a href="#">NEWS</a></li>
        ...
        <div class="cont flex-ai-c">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 31.951 31.951">
    ...
    <div class="news">
        <div class="top flex flex-jc-c">
            <div class="tit">FEATURED NEWS</div>
            ...
            <ul class="flex flex-jc-c">
                <li>
                    <a href="#">
                        ...
                        <div class="post">
                            <h3>General/Pcs1</h3>
                            <h2>Four PUBG Continental Series 1<br> Champions Emerge: Qconfirm, TSM,<br> Infantry, and STK</h2>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        ...
                        <div class="post">
                            <h3>General</h3>
                            <h2>Dev Letter: Deep Dive into PUBG<br> Esports Player Stats+(PEPS+)</h2>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        ...
                        <div class="post">
                            <h3>General/Pcs1</h3>
                            <h2>PCS1 Match Days 1 &amp; 2: Qconfirm Leads<br> in APAC, STK in North America</h2>
                        </div>
                    </a>
                </li>
            </ul>
...
<div class="banner flex flex-jc-c">
    <div class="box-1 box">
        <img src="https://hwanghyeonjeong.github.io/img1/pf/pcs/sample_main_banner01.jpg" alt="">
        <div class="post">
            <h3>2020 PCS<br>STREAMING CHANNELS</h3>
            <div class="sum">Check out English broadcasts for all regions!</div>
            <ul class="flex-jc-sb flex">
                <li> <a href="#"> Twitch</a></li>
                <li><a href="#"> YouTube(PUBG)</a></li>
                <li><a href="#"> YouTube(Esports)</a></li>
                <li><a href="#"> More Languages</a></li>
            </ul>
        </div>
    </div>
    <div class="box-2 box">
        <img src="https://hwanghyeonjeong.github.io/img1/pf/pcs/sample_main_banner02.jpg" alt="">
        <div class="post">
            <h3>2020 PUBG<br>GLOBAL ESPORTS RULESET</h3>
            <div class="sum">Standard & Universal</div>
            <ul class="flex-jc-sb flex">
...
<div class="line flex-ai-c">
    <div class="img-box">
        <img src="https://hwanghyeonjeong.github.io/img1/pf/pcs/bg_footer_sns.jpg" alt="">
    </div>
    <div class="txt">
        <div class="icon flex-jc-sb">
...
<div class="footer flex">
    <div class="box-1 flex-as-c">
        ...
        <div class="box-2">
            ...
            COPYRIGHT ©2019-2020 PUBG CORPORATION. ALL RIGHTS RESERVED.<br>PLAYERUNKNOWN’S BATTLEGROUNDS and PUBG are registered trademarks, trademarks or service marks of PUBG.
            </div>
            <div class="copy copy-2">Partnership Inquiry: PUBG_Partnership@pubg.com</div>
        </div>
    </div>
    <div class="box-3"><img src="https://hwanghyeonjeong.github.io/img1/pf/pcs/esrb.png" alt=""></div>
</div>
